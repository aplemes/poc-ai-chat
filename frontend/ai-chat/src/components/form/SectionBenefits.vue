    ...
    <div class="fields-grid">
      <div class="field">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'benefitCategory' }" @click="fieldChatStore.openPanel('benefitCategory')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('benefitCategory')" :class="badgeClass('benefitCategory')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
        <div class="select-wrap" :class="{ 'ai-filled': aiFilledFields.has('benefitCategory'), 'has-error': errors['benefitCategory'] }">
          <select id="benefitCategory" v-model="form.benefitCategory" @change="clearField('benefitCategory')">
      ...
      <div class="field field--full">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'benefitHypothesis' }" @click="fieldChatStore.openPanel('benefitHypothesis')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('benefitHypothesis')" :class="badgeClass('benefitHypothesis')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
        <textarea
      ...
      <div class="field field--full">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'measureBenefits' }" @click="fieldChatStore.openPanel('measureBenefits')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('measureBenefits')" :class="badgeClass('measureBenefits')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
