    ...
    <div class="fields-grid">
      ...
      <div class="field field--full">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'title' }" @click="fieldChatStore.openPanel('title')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('title')" :class="badgeClass('title')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
        <p class="field-hint">Start with an infinitive verb + scope. e.g. "Add the new Payment Method X on website"</p>
        <input id="title" v-model="form.title" type="text" placeholder="Add the new... / Improve the... / Enable..." :class="{ 'ai-filled': aiFilledFields.has('title'), 'has-error': errors['title'] }" @input="clearField('title')" />
      ...
      <div class="field">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'businessLine' }" @click="fieldChatStore.openPanel('businessLine')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('businessLine')" :class="badgeClass('businessLine')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
        <div class="select-wrap" :class="{ 'ai-filled': aiFilledFields.has('businessLine'), 'has-error': errors['businessLine'] }">
          <select id="businessLine" v-model="form.businessLine" @change="clearField('businessLine')">
      ...
      <div class="field">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'requesterBU' }" @click="fieldChatStore.openPanel('requesterBU')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('requesterBU')" :class="badgeClass('requesterBU')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
      ...
      <div class="field field--full">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'busInterested' }" @click="fieldChatStore.openPanel('busInterested')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('busInterested')" :class="badgeClass('busInterested')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
        <div class="chips-field" :class="{ 'ai-filled': aiFilledFields.has('busInterested') }">
          ...
          <div class="select-wrap chips-select">
            <select value="" @change="(e) => { const v = (e.target as HTMLSelectElement).value; if (v) toggleBusInterested(v); (e.target as HTMLSelectElement).value = '' }">
      ...
      <div class="field field--full">
        <div class="label-row">
          ...
          <div class="label-actions">
            <button type="button" class="field-ai-btn" :class="{ active: fieldChatStore.activeField === 'timeSensitive' }" @click="fieldChatStore.openPanel('timeSensitive')">✦</button>
            <Transition name="badge"><span v-if="aiFilledFields.has('timeSensitive')" :class="badgeClass('timeSensitive')"><span class="ai-dot"></span>AI</span></Transition>
          </div>
        </div>
        <div class="segmented" :class="{ 'ai-filled': aiFilledFields.has('timeSensitive') }">
          <button v-for="opt in timeSensitiveOptions" :key="opt" type="button" class="seg-btn" :class="{ active: form.timeSensitive === opt }" @click="selectTimeSensitive(opt)">
            {{ opt }}
          </button>
        </div>
      </div>
