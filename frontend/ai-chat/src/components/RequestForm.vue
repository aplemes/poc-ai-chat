...
const { analysisOpen, analysisLoading, analysisText, analysisError, handleSubmit, closeAnalysis, renderMd } =
  useFormAnalysis(() => ({ ...form.value, lowConfidenceFields: [] }), validate)
